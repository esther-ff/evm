...
use lychee_util::flags::{Flags, HirDump};
use lychee_util::sources::FileManager;
        ...
        match cmd_arg {
            ...
            Argument::Long("dump") => {
                ...
                for dump_opt in options {
                    match dump_opt {
                        "air_items" => flags.dump_hir = HirDump::Simple,
                        "air" => flags.dump_hir = HirDump::WithBodies,
