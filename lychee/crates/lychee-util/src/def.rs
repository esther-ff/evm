...
impl DefPath {
    ...
    pub fn push_type_ns(&mut self, sym: SymbolId) {
        self.segments.push(DefPathSeg::TypeNs(sym))
    }

    pub fn push_value_ns(&mut self, sym: SymbolId) {
        self.segments.push(DefPathSeg::ValueNs(sym))
    }
