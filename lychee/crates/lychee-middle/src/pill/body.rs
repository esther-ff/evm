mod private {
    ...
    lychee_util::newtyped_index!(Local, LocalMap, LocalVec, LocalsSlice);
...
use crate::typing::ty::{Ty, TyKind};
use lychee_air::lowering_ast::AirId;
use lychee_air::node::{AirLiteral, Constant};
use lychee_ast as ast;
