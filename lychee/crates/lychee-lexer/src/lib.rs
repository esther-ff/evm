...
use lychee_util::sources::SourceId;
...
fn check_for_keyword(ident: &str) -> Option<TokenKind> {
    use TokenKind::{
        Bind, Break, Const, Else, False, For, Function, If, Instance, Let, Loop, Match, Mut,
        Native, Pub, Realm, Return, SelfArg, Then, True, Until, While, With,
    };
